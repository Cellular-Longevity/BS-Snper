...
sub Bayes
{
    ...
    if($genotypemaybe eq "CT"){
        if($crick[1]==0){
            $genotypemaybe = "CC";
        # if no C evidence on reverse strand, it's homozygous T
        }elsif($crick[2] == 0){
            $genotypemaybe = "TT";
        }elsif($crick[1]<3){
            $genotypemaybe = "NN";
    ...
    if($genotypemaybe eq "AG"){
        if($watson[0] == 0){
            $genotypemaybe = "GG";
        # if no G evidence on forward strand, it's homozygous A
        }elsif($watson[3] == 0){
            $genotypemaybe = "AA";
        }elsif($watson[0] <3){
            $genotypemaybe = "NN";
    ...
    # print "watson[0]\twatson[1]\twatson[2]\twatson[3]\n";
    # print "$watson[0]\t$watson[1]\t$watson[2]\t$watson[3]\n";
    # print "crick[0]\tcrick[1]\tcrick[2]\tcrick[3]\n";
    # print "$crick[0]\t$crick[1]\t$crick[2]\t$crick[3]\n";
    # print "$genotypemaybe\t$qual\n";
...
## ALT BLOCK FOR ABOVE
    # if($genotypemaybe eq "CT"){
    #     my $tfrq = 0;
    #     if (($crick[1]+$crick[2]) == 0 ){
    #         my $tfrq = 0;
    #     } else {
    #         my $tfrq=$crick[1]/($crick[1]+$crick[2]);
    #     }
    #     if($tfrq < $minhetfreq){
    #         $genotypemaybe = "CC";
    #     # if no C evidence on reverse strand, it's homozygous T
    #     }elsif($tfrq > $minhomfreq){
    #         $genotypemaybe = "TT";
    #     }elsif($crick[1]<3){
    #         $genotypemaybe = "NN";
    #     }
    ...
    # if($genotypemaybe eq "AG"){
    #     my $afrq = 0;
    #     if (($watson[0]+$watson[3])){
    #         my $afrq = 0;
    #     } else {
    #         my $afrq=$watson[0]/($watson[0]+$watson[3]);
    #     }
    #     # if($watson[0] == 0){
    #     if($afrq < $minhetfreq){
    #         $genotypemaybe = "GG";
    #     # if no G evidence on forward strand, it's homozygous A
    #     }elsif($afrq > $minhomfreq){
    #         $genotypemaybe = "AA";
    #     }elsif($watson[0] <3){
    #         $genotypemaybe = "NN";
    #     }
